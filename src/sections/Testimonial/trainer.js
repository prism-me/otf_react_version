...
const Trainer = ({ memberreviewData, title, language, isArabic }) => (
  <section
    className="app2 gym membersaysabout "
    style={{
      background: "#f2f2f2",
    }}
  >
    <Container>
      ...
      <Row>
        <Col xs="12">
          <Slider
            className="owl-carousel owl-theme membersaysabout-slider"
            {...settings}
          >
              ...
              <div className="item" key={i}>
                <div className="membersaysabout-container">
                  <h5 className="name text-center pt-3">
                    {isArabic ? x?.arabic?.title : x?.title}
                  </h5>
                  ...
                  <div className="text-center">
                    <p
                      className="membersaysabout-para"
                    ...
                    {x.img === null ? (
                      ...
                      <center>
                        <a href="#" target={"_blank"}>
                          <img
                            alt=""
                            className="img-fluid members mt-5 mb-2"
                            src={x.img}
                          />
                        </a>
                      </center>
