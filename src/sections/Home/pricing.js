...
const Pricing = ({ membershipsData, isArabic, language }) => {
  ...
  return (
    <section className="gym pricing set-relative pb-0" id="membership_packages">
      <Container>
        <Row>
          <Col md="10" className="offset-md-1">
            ...
            <p className="oftsubHeading text-center mb-5">
              It only takes a minute in our studio to understand it’s not a
              competition – it’s a community. Check out our membership options
              and contact your local studio to find the right fit for you.
            </p>
          </Col>
                      ...
                      <div className="price-feature-container set-relative">
                        <div className="feature-text">
                          ...
                          <h4 className="feature-text-heading text-center bold text-uppercase font-primary">
                            {isArabic ? item?.arabic?.name : item?.name}
                          </h4>
                        ...
                        >
                          <span style={{ borderBottom: "1px solid #F58220" }}>
                            join now
                          </span>
                        </button>
                      </div>
